    ...
    pub fn new(tile_type: TileType) -> Tile {
        ...
        let path_str = format!(
            ...
            match tile_type {
                ...
                TileType::TrackCornerSmall => "terrain-grass.obj",
                TileType::TrackLeftRightLarge => "terrain-grass.obj",
                TileType::TrackPitEntryLaneSmall => "terrain-grass.obj",
                TileType::TrackPitEntryLarge => "terrain-grass.obj",
                TileType::TrackPitExitLaneSmall => "terrain-grass.obj",
                TileType::TrackPitExitLarge => "terrain-grass.obj",
                TileType::TrackRightLeftLarge => "terrain-grass.obj",
                TileType::TrackStartFinish => "terrain-grass.obj",
                TileType::TrackStraightSmall => "terrain-grass.obj",
                TileType::TrackTire => "terrain-grass.obj",
            }
        );
